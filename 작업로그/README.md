...
| 2026-05-11 | [065-delisting-estimated](./2026-05-11-065-delisting-estimated.md) | 22 | backtest-engine-developer | ✅ | delisting_estimated 처리 — 상장폐지 예정 종목 종가×0.5 강제매도 + exit_reason + 6건 신규 테스트, 1106 PASS |
| 2026-05-11 | [064-priority-3-methods](./2026-05-11-064-priority-3-methods.md) | 22 | backtest-engine-developer | ✅ | priority 3종 엔진 구현 (02-s) — market_cap_asc·volume_ratio_desc·price_change_desc + 17건 신규 테스트, 1100 PASS |
| 2026-05-11 | [063-stop-trading-on-drawdown](./2026-05-11-063-stop-trading-on-drawdown.md) | 22 | backtest-engine-developer | ✅ | stop_trading_on_drawdown_pct MDD 거래중단 구현 (02-r) — _is_drawdown_limit_exceeded() + 13건 신규 테스트, 1083 PASS |
...
| 2026-05-11 | [041-avg-trading-value-market-index-filter](./2026-05-11-041-avg-trading-value-market-index-filter.md) | 14 | condition-author | ✅ | avg_trading_value(거래대금 N일 평균 필터) + market_index_filter(지수 등락률 필터) — 03-f·g 해소, 1109 PASS |
...
## Phase 14 완료 ✅ (4/4 step + test-engineer 🟢 ship-go)

### 완료 step
- ✅ 041 avg_trading_value + market_index_filter 등록 (03-f·g, 1109 PASS)
- ✅ 042 macd_cross + macd_histogram 등록 (03-h·i, 1140 PASS)
- ✅ 043 new_high_breakout + gap_pct + momentum_return 등록 (03-j·k·l, 1168 PASS)
- ✅ 044 bullish_candle + price_change_pct 등록 (03-m·n, 1192 PASS)
...
## Phase 16 완료 (4/4 step) — test-engineer 검증 대기

### 완료 step
- ✅ 048 HistoricalBackfillJob 7단계 + BackfillCheckpoint + RateLimiter (14-l, 1258 PASS)
- ✅ 049 DailyUpdateJob 증분 수집 + MissingDataCheckJob 연동 (14-m, 1265 PASS)
- ✅ 050 PykrxProvider 완전 구현 (06-j, 1279 PASS) — 06번 91%→100% ✅
...
## Phase 17 완료 ✅ (2/2 step, test-engineer 🟢 ship-go)
