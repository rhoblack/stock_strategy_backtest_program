...
| 1 | 백엔드 핵심 엔진 (조건 5개 + StrategyEngine + 단일종목 백테스트 + Metrics) | 🔄 진행 중 (3/9) |
...
**현재 작업 중**: 없음 (Phase 1 / Step 4 — 기본 조건 5개 작성 — 다음에 시작)

**환경 셋업 완료**: `backend/.venv/` 활성화 후 `./.venv/Scripts/python.exe -m pytest` 로 검증 가능. 53/53 통과 상태.
...
4. ⏭ **다음**: 기본 조건 5개 작성 (price_vs_ma / ma_cross / volume_ratio / rsi_level / take_profit)
