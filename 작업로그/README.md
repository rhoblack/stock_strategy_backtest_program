...
| 1 | 백엔드 핵심 엔진 (조건 5개 + StrategyEngine + 단일종목 백테스트 + Metrics) | 🔄 진행 중 (2/9) |
...
**현재 작업 중**: 없음 (Phase 1 / Step 3 — indicators.py + compare 유틸리티 — 다음에 시작)
...
3. ⏭ **다음**: compare 유틸리티 + indicators.py (이동평균, RSI, MACD)
